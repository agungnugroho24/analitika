            ...
            <div class="row">
                ...
                <div class="col-md-6 slider-content">
                    ...
                    <div class="btn-sec">
                        ...
                        <!-- <button class="btn button1 font-weight-bold" data-toggle="modal" data-target="#show"><i class="fa fa-search-plus"></i> Preview</button>
                            <a href="<?php echo base_url(); ?>welcome/download/<?php echo $u->id; ?>" style="color: #000000;">
                                <form class="cmxform form-horizontal tasi-form" enctype="multipart/form-data" action="<?php echo base_url(). 'Admin/hitcounter'; ?>" method="post">
                                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                                <input type="hidden" name="id" value="<?php echo $u->id ?>">
                                <input type="hidden" name="hitcounter" value="<?php echo $u->hitcounter+1 ?>">
                                <button class="btn button2 font-weight-bold"><i class="fa fa-download"></i> Download</button>
                                </form>
                            </a> -->
    ...
    <section class="related-books">
        <div class="container">
            ...
            <div class="recomended-sec">
                <iframe src="<?php echo site_url('welcome/content');?>"></iframe>
                <!-- <div class="row">
