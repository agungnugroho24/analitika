...
<a href="#" class="logo"><span>analitika</span></a>
  ...
  <ul class="nav pull-right top-menu">
      ...
      <li class="dropdown">
          <a data-toggle="dropdown" class="dropdown-toggle" href="#">
              ...
              <!-- <img alt="" src="https://akun.bappenas.go.id/bp-um/avatar/<?= $this->session->userdata('avatar') ?>"> -->
          ...
          <ul class="dropdown-menu extended logout">
              ...
              <!-- <li><a href="<?php echo base_url() ?>"><i class=" fa fa-home"></i>Front page</a></li>
